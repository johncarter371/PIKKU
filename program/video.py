        ...
        [
            [
                InlineKeyboardButton(
                    text="ʙᴏᴛ ɢʀᴏᴜᴘ", url=f"https://t.me/PIKKUMUSIC_SUPPORT"
                ),
                InlineKeyboardButton(
                    text="ʙᴏᴛ ᴄʜᴀᴀɴɴᴇʟ", url=f"https://t.me/PIKKUMUSIC_SUPPORT"
                ),
            ]
        ]
    )
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [
                ...
                InlineKeyboardButton(
                    text="ʙᴏᴛ ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/PIKKUMUSIC_SUPPORT"
                ),
            ]
        ]
    )
