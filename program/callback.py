        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    ...
                    InlineKeyboardButton("ᴄʀᴇᴀᴛᴏʀ", url=f"https://t.me/pikka01001"),
                ],
                [
                    InlineKeyboardButton(
                    ...
                    InlineKeyboardButton(
                        "ʙᴏᴛ ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/PIKKUMUSIC_OFFICIAL"
                    ),
                ],
                [
                    InlineKeyboardButton(
                        "ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ", url=f"https://t.me/PIKKAUMUSIC_OFFICIAL"
                    )
                ],
            ]
        ),
