...
async def start_(client: Client, message: Message):
    await message.reply_sticker("https://te.legra.ph/file/8ab6f1047e168e034bc14.jpg")
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    ...
                    InlineKeyboardButton("ᴄʀᴇᴀᴛᴏʀ", url=f"https://t.me/pikku01001"),
                ],
                [
                    InlineKeyboardButton(
                        "ʙᴏᴛ ɢʀᴏᴜᴘ", url=f"https://t.me/PIKKUMUSIC_SUPPORT"
                    ),
                    InlineKeyboardButton(
                        "ʙᴏᴛ ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/PIKKUMUSIC_SUPPORT"
                    ),
                ],
                [
                    InlineKeyboardButton(
                        "ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ", url=f"https://t.me/PIKKUMUSIC_SUPPORT"
                    )
                ],
            ]
        ),
...
async def alive(client: Client, message: Message):
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton("ʙᴏᴛ ɢʀᴏᴜᴘ", url=f"https://t.me/PIKKUMUSIC_SUPPORT"),
                InlineKeyboardButton(
                    "ʙᴏᴛ ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/PIKKUMUSIC_SUPPORT"
                ),
            ]
